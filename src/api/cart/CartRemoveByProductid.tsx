...
const RemoveByProductID = async (id: number) => {
  const response = await axiosInstance.put(
    `/cart/removalOfCartByProductId/${id}`
  );
  return response.data;
};

export const useRemovebyProductId = (id: number) => {
  ...
  return {
    ...
    RemoveProductdata: mutation.data,
    Productremoveloading: mutation.isPending,
    ProductRemovederror: mutation.isError
      ? (mutation.error as unknown as Error).message
      : null,
    ProductRemovedSuccessfully: mutation.isSuccess,
  };
};
